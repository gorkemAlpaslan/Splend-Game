...
import LightsOutGame from "@/components/games/lights-out-game";
...
export default function LightsOutGamePage() {
  ...
  return (
    <div className={style.gameWrapper} id="game-page-wrapper">
      <Head>
        <title>Lights Out - Splend Game</title>
        <meta name="description" content="Toggle network sector anomalies to switch off all node anomalies." />
      </Head>

      <header className={style.gameHeader} style={{ background: "transparent", borderBottom: "none" }} id="game-header">
        <div className={style.logoTitle}>LIGHTS OUT ANOMALY</div>
          ...
          >
            ...
            <div className={style.rulesList}>
              <div className={style.ruleItem}>
                ...
                <div className={style.ruleText}><strong>Grid Structure:</strong> You are presented with a 5x5 grid of nodes that are either illuminated (On) or dark (Off).</div>
              </div>

              <div className={style.ruleItem}>
                <div className={style.ruleNum}>2</div>
                <div className={style.ruleText}><strong>State Flipping:</strong> Clicking a node flips the state of that node and all its direct orthogonal neighbors (above, below, left, and right).</div>
              </div>

              <div className={style.ruleItem}>
                <div className={style.ruleNum}>3</div>
                <div className={style.ruleText}><strong>Objective:</strong> Deactivate and turn off all nodes in the grid simultaneously to override the lock.</div>
              </div>

              <div className={style.ruleItem}>
                <div className={style.ruleNum}>4</div>
                <div className={style.ruleText}><strong>Difficulty Scale:</strong> Higher difficulty levels start with more randomized initial cell states, requiring more complex deduction patterns to resolve.</div>
              </div>
            </div>
          </div>
        </div>
